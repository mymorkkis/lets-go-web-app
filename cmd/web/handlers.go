...
import (
	...
	"github.com/mymorkkis/lets-go-web-app/internal/validator"
)

// TODO Split these out into seperate files or a package
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	// If we want to limit the request body size, we can set like below
